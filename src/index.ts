...
const server = new McpServer(
	...
	},
	{
		instructions: [
			...
			'Some features, such as creating preview sites, require authentication. Do NOT attempt to run the login command yourself. Instead, instruct the user to manually run "~/.wordpress-studio-mcp/bin/studio-cli auth login" in their own terminal.',
