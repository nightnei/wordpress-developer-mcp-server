...
const server = new McpServer(
	...
	},
	{
		instructions: [
			...
			'Never direct the user to open the Studio application. This MCP server is fully standalone and can perform all actions itself. Always find an alternative approach using the available tools.',
